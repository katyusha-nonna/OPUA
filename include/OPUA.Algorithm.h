		...
		*/
		...
		/*
			...
			求解参数说明：
				...
				OPUA.Algorithm.BD.MIPSolverMode / OpChar / 'C' / {'G', 'C', 'S', 'M', 'T', 'K', 'B'} /  注释：MIP求解器选择：G-GRB / C-CPX / S-SCIP / M-MSK / T-COPT / K-GLPK / B-CBC
			备注：
		...
		*/
		...
		/*
			...
			求解参数说明：
				...
				OPUA.Algorithm.CCG.MIPSolverMode / OpChar / 'G' / {'G', 'C', 'S', 'M', 'T', 'K', 'B'} /  注释：MIP求解器选择：G-GRB / C-CPX / S-SCIP / M-MSK / T-COPT / K-GLPK / B-CBC
		*/
		class OpAlgoCCG
		{
		protected:
		...
		*/
		...
		/*
			...
			求解参数说明：
					...
					OPUA.Algorithm.ATC.MIPSolverMode / OpChar / 'G' / {'G', 'C', 'S', 'M', 'T', 'K', 'B'} /  注释：MIP求解器选择：G-GRB / C-CPX / S-SCIP / M-MSK / T-COPT / K-GLPK / B-CBC
		*/
		class OpAlgoATC
		{
		protected:
